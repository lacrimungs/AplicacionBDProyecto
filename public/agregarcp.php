...
<nav>
    ...
    <div class="container">
        ...
        <form action="compra.php" method="POST">
            <label for="nombre_compra">Nombre de tu compra</label>
            <input type="text" name="nombre_compra" id="nombre_compra" required>
            
            <label for="cantidad">Cantidad de tu compra</label>
