...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE distribuidor SET nombre='$nombre', apellidoP='$apellidoP', apellidoM='$apellidoM', telefono='$telefono', region_distribuidora='$region_distribuidora', genero='$genero', categoria_id='$categoria_id', producto_id='$producto_id' WHERE id='$distribuidor_id'";
    ...
    $sql = "SELECT * FROM distribuidor WHERE id = '$distribuidor_id'";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $region_distribuidora = $row["region_distribuidora"];
            $genero = $row["genero"];
    ...
    <div class="container">
        ...
        <form action="editar_registrod.php" method="POST">
            ...
            <label for="region_distribuidora">Región Distribuidora</label>
            <input type="text" name="region_distribuidora" id="region_distribuidora" value="<?php echo $region_distribuidora; ?>" required>
