...
<nav>
    ...
    <form action="distribuidor.php" method="POST">
        ...
        <label for="region_disribuidora">Región Distribuidora</label>
        <input type="text" name="region_disribuidora" id="region_disribuidora" required>
